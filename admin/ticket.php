		...
		<div class="col-xs-12 col-sm-12">
			<nav class="navbar menu_hor">
				<ul class="nav navbar-nav">
					...
					<li><a href="?op=form" class="active">Ticket</a></li>
	...
	<div class="row">
		<form action="" method="" class="form2">
			<div class="contenedor">
				<div class="row">
					<div class="col-sm-8">
						<h1 class="naranja">Cuéntanos de la Boletería</h1>
						<h2 class="naranja">¿Cuantos Tickets se van a vender?</h2>

						<div class="mar_left select_ad">
